...
namespace API_SALES_ORDER_SRV
{
    ...
    public class A_SalesOrderHeaderPartnerType : BaseDTOWithIDAndETag
    {
        ...
        {   
            get 
            {
                ...
                result.Add("PrimaryKey", new List<string>() {"SalesOrder","PartnerFunction"});
                result.Add("to_SalesOrder", new List<string>() {"SalesOrder","PartnerFunction"});
