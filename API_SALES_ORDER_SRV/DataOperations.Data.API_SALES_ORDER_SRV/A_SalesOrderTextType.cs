...
namespace API_SALES_ORDER_SRV
{
    ...
    public class A_SalesOrderTextType : BaseDTOWithIDAndETag
    {
        ...
        {   
            get 
            {
                ...
                result.Add("PrimaryKey", new List<string>() {"SalesOrder","Language","LongTextID"});
                result.Add("to_SalesOrder", new List<string>() {"SalesOrder","Language","LongTextID"});
