...
namespace API_SALES_ORDER_SRV
{
    ...
    public class A_SalesOrderItemRelatedObjectType : BaseDTOWithIDAndETag
    {
        ...
        {   
            get 
            {
                ...
                result.Add("PrimaryKey", new List<string>() {"SalesOrder","SalesOrderItem","SDDocRelatedObjectSequenceNmbr"});
                result.Add("to_SalesOrder", new List<string>() {"SalesOrder","SalesOrderItem","SDDocRelatedObjectSequenceNmbr"});
                result.Add("to_SalesOrderItem", new List<string>() {"SalesOrder","SalesOrderItem","SDDocRelatedObjectSequenceNmbr"});
