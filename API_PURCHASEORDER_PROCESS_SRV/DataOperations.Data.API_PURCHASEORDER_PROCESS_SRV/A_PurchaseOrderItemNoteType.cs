...
namespace API_PURCHASEORDER_PROCESS_SRV
{
    ...
    public class A_PurchaseOrderItemNoteType : BaseDTOWithIDAndETag
    {
        ...
        {   
            get 
            {
                ...
                result.Add("PrimaryKey", new List<string>() {"PurchaseOrder","PurchaseOrderItem","TextObjectType","Language"});
